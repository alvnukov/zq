...
pub use query::{
    ...
    run_json_query as run_native_json_query,
    ...
    run_yaml_query as run_native_yaml_query,
    validate_query as validate_native_query,
    validate_query_with_paths as validate_native_query_with_paths,
    InputKind as NativeInputKind,
    ParsedInput as NativeParsedInput,
    PreparedQuery as NativePreparedQuery,
